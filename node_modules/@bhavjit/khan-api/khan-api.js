...
`;
  ...
  var _User = class extends Wrapper {
    constructor() {
      super(...arguments);
    ...
    async get(client = this.client ?? new Client()) {
      const user = await client.getUser(__privateMethod(this, _resolveIdentifier, resolveIdentifier_fn).call(this));
      return this.copy(user);
    }
    async getAvatar(client = this.client ?? new Client()) {
      const url = await client.getAvatar(__privateMethod(this, _resolveIdentifier, resolveIdentifier_fn).call(this));
      this.copy({ avatar: url });
      return url;
    }
    async getStatistics(client = this.client ?? new Client()) {
      const statistics = await client.getUserStatistics(__privateMethod(this, _resolveIdentifier, resolveIdentifier_fn).call(this));
...
Scratchpad${encoded}\f`
  ...
  var _resolveIdentifier2, resolveIdentifier_fn2;
  var _Program = class extends Wrapper {
    constructor() {
      super(...arguments);
      __privateAdd(this, _resolveIdentifier2);
    }
    get spinoff() {
    ...
    async *getTipsAndThanks(client = this.client ?? new Client(), sort) {
      for await (const messages of client.getProgramTipsAndThanks(
        __privateMethod(this, _resolveIdentifier2, resolveIdentifier_fn2).call(this),
        sort
      )) {
  ...
  _resolveIdentifier2 = new WeakSet();
  resolveIdentifier_fn2 = function() {
    if (this.id)
      return this.id;
    if (this.key)
      return this.key;
  ...
  var _Client = class {
    ...
    async *getUserPrograms(identifier, sort = "TOP" /* TOP */, limit = 40) {
      ...
      identifier ?? (identifier = this.kaid ?? this.user?.username ?? this.user?.email);
      if (!identifier)
...
//# sourceMappingURL=khan-api.js.map
